...
export function SubmissionForm({ locale }: { locale: Locale }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if ((result.village !== "gundancharla" && result.village !== "project-wide") || !result.id) throw new Error(copy.genericError);
...
const english = {
  title: "Update title", titlePlaceholder: "What happened?", location: "Location", gundancharla: "Gundancharla", projectWide: "Project-wide", category: "Category", date: "Event date (optional)", media: "Photos or videos (optional)", mediaHint: "Up to 6 files. JPEG, PNG, WebP or MP4; 5 MB total per submission.", content: "Update details", contentPlaceholder: "Describe what happened, where, when, who reported it, and any source or evidence available.", socialLinks: "Social media links (optional)", socialLinksHint: "Up to 5 public Instagram, Facebook, YouTube, X or Twitter links. Add one per line.", socialLinksPlaceholder: "https://www.instagram.com/reel/…", rights: "If I attach media, I confirm I have permission to submit it for archiving and public display, and that it does not expose private identity, bank, Aadhaar, signature, phone or children’s sensitive information without consent.", publicNotice: "The update is published immediately as a Community Report. This label does not mean VeligondaStories has independently verified it.", submit: "Publish update", submitting: "Publishing…", genericError: "The update could not be submitted. Please try again; nothing was removed from earlier submissions.", tooLarge: "The upload is too large for the publishing service. Keep all attached files under 5 MB total.", categories: { ground: "Ground reality", rehabilitation: "Rehabilitation / R&R", development: "Project development", document: "Document update", story: "Village story", other: "Other" },
};

const telugu = {
  title: "అప్‌డేట్ శీర్షిక", titlePlaceholder: "ఏం జరిగింది?", location: "ప్రాంతం", gundancharla: "గుండంచర్ల", projectWide: "ప్రాజెక్టు మొత్తం", category: "వర్గం", date: "సంఘటన తేదీ (ఐచ్చికం)", media: "ఫోటోలు లేదా వీడియోలు (ఐచ్చికం)", mediaHint: "గరిష్ఠంగా 6 ఫైళ్లు. JPEG, PNG, WebP లేదా MP4; ప్రతి సమర్పణ మొత్తం 5 MB.", content: "అప్‌డేట్ వివరాలు", contentPlaceholder: "ఏం జరిగింది, ఎక్కడ, ఎప్పుడు, ఎవరు నివేదించారు, అందుబాటులో ఉన్న మూలం లేదా ఆధారం వివరించండి.", socialLinks: "సోషల్ మీడియా లింకులు (ఐచ్చికం)", socialLinksHint: "గరిష్ఠంగా 5 పబ్లిక్ Instagram, Facebook, YouTube, X లేదా Twitter లింకులు. ప్రతి లింకును కొత్త లైన్‌లో జోడించండి.", socialLinksPlaceholder: "https://www.instagram.com/reel/…", rights: "మీడియా జతచేస్తే, ఆర్కైవ్ మరియు ప్రజా ప్రదర్శన కోసం సమర్పించే అనుమతి నాకు ఉందని, సమ్మతి లేకుండా వ్యక్తిగత గుర్తింపు, బ్యాంకు, ఆధార్, సంతకం, ఫోన్ లేదా పిల్లల సున్నితమైన సమాచారం లేదని నిర్ధారిస్తున్నాను.", publicNotice: "ఈ అప్‌డేట్ వెంటనే సామాజిక నివేదికగా ప్రచురించబడుతుంది. ఈ లేబుల్ VeligondaStories స్వతంత్రంగా ధృవీకరించిందని అర్థం కాదు.", submit: "అప్‌డేట్ ప్రచురించండి", submitting: "ప్రచురిస్తోంది…", genericError: "అప్‌డేట్ సమర్పించలేకపోయాము. దయచేసి మళ్లీ ప్రయత్నించండి; పాత సమర్పణలు తొలగించబడవు.", tooLarge: "అప్‌లోడ్ చాలా పెద్దది. జతచేసిన అన్ని ఫైళ్ల మొత్తం 5 MB లోపు ఉంచండి.", categories: { ground: "నేలమీద పరిస్థితి", rehabilitation: "పునరావాసం / ఆర్ అండ్ ఆర్", development: "ప్రాజెక్టు అభివృద్ధి", document: "పత్రం అప్‌డేట్", story: "గ్రామ కథ", other: "ఇతర" },
};
